      ...
      <div className="relative pt-24 pb-16 sm:pt-32 sm:pb-24 px-6 text-center overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto">
          ...
          <h1 className="text-[clamp(2rem,6vw,3.5rem)] font-display font-extrabold mb-4">
            Sejarah <span className="bg-linear-to-r from-orange-400 via-orange-400 to-orange-600 bg-clip-text text-transparent">PARSTAMA</span>
          </h1>
      ...
      <div className="max-w-4xl mx-auto px-6 pb-24 space-y-16 sm:space-y-20">
        ...
        <section>
          <div className="flex items-center gap-3 mb-6">
            <div className="w-10 h-10 rounded-xl bg-orange-600/15 border border-orange-500/20 flex items-center justify-center shrink-0">
              <svg className="w-5 h-5 text-orange-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" /></svg>
            </div>
        ...
        <section>
          <div className="flex items-center gap-3 mb-6">
            <div className="w-10 h-10 rounded-xl bg-orange-600/15 border border-orange-500/20 flex items-center justify-center shrink-0">
              <svg className="w-5 h-5 text-orange-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" /></svg>
            </div>
        ...
        <section>
          <div className="flex items-center gap-3 mb-6">
            <div className="w-10 h-10 rounded-xl bg-orange-600/15 border border-orange-500/20 flex items-center justify-center shrink-0">
              <svg className="w-5 h-5 text-orange-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" /></svg>
            </div>
            <h2 className="text-xl sm:text-2xl font-display font-extrabold text-white">Harapan</h2>
          </div>
          <div className="bg-[#141415] border border-orange-500/10 rounded-2xl p-6 sm:p-8">
            <p className="text-zinc-300 text-sm sm:text-base leading-relaxed">
        ...
        <div className="text-center pt-8 border-t border-white/6">
          ...
          <RocketButton href="/daftar" className="inline-flex items-center justify-center gap-2 px-7 sm:px-8 py-3 rounded-full text-sm font-bold text-white bg-linear-to-r from-orange-600 to-orange-800 shadow-lg shadow-orange-600/30 hover:shadow-orange-600/50 hover:-translate-y-0.5 transition-all">
