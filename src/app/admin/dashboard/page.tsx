            ...
            <div className="chart-container">
              <ResponsiveContainer width="100%" height={250}>
                <BarChart data={analytics.dailyData} margin={{ top: 20, right: 10, left: -10, bottom: 5 }}>
                  ...
                  <Tooltip contentStyle={{ background: "rgba(20,20,22,0.95)", border: "1px solid rgba(220,38,38,0.3)", borderRadius: 12, color: "#fff", fontSize: 12 }} cursor={{ fill: "rgba(220,38,38,0.05)" }} />
